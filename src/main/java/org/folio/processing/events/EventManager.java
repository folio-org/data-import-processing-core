...
public final class EventManager {
  ...
  public static CompletableFuture<DataImportEventPayload> handleEvent(DataImportEventPayload eventPayload,
                                                                      ProfileSnapshotWrapper jobProfileSnapshot) {
  ...
  private static CompletableFuture<Boolean> publishEventIfNecessary(DataImportEventPayload eventPayload,
                                                                    ProfileSnapshotWrapper jobProfileSnapshot,
   ...
   */
  private static DataImportEventPayload prepareEventPayload(DataImportEventPayload eventPayload,
                                                            ProfileSnapshotWrapper jobProfileSnapshot,
                                                            Throwable throwable) {
    if (throwable != null) {
  ...
  private static Optional<ProfileSnapshotWrapper> getNextChildProfile(ProfileSnapshotWrapper currentChild,
                                                                      ProfileSnapshotWrapper parent) {
  ...
  private static DataImportEventPayload prepareErrorEventPayload(DataImportEventPayload eventPayload,
                                                                 Throwable throwable) {
